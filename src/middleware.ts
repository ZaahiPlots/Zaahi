 ...
 * - /api/referral-waitlist — public Coming Soon email signup posted from the
 *                       /refer landing. Single-field opt-in (email), rate
 *                       limited per ip-hash inside the route handler.
 *                       Founder 2026-04-30.
 */
const PUBLIC_API = [
  '/api/auth',
  '/api/notify-admin',
  '/api/referral-waitlist',
];
