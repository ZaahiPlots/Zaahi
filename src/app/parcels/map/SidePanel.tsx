        ...
        <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 8, fontSize: 11 }}>
          ...
          {plan ? (
            <>
              ...
              {/* General Notes + Documents moved BELOW the Feasibility
                  Calculator (founder 2026-06-08 — reverting the reorder
                  from commit ac7ce70). Both blocks render after the
                  Calculator section; nothing renders above it here. */}
              ...
              {/* General Notes — visual hybrid (parking table + NOC
                  checklist + design callout + raw DDA toggle). Sits
                  AFTER the Feasibility Calculator per founder
                  2026-06-08. */}
              ...
              {/* Documents — Affection Plan + Plot Details PDFs.
                  Original position restored 2026-06-08 (reverting the
                  reorder from commit ac7ce70). DDA Bearer-auth download
                  flow unchanged. */}
