...
- **Anti-dilution — Platform:** **Weighted-average (broad-based)** protection applicable up to (and including) the first closing of a priced Series A financing only. After the Series A first closing, anti-dilution terminates and Rudi has **pro-rata rights** — the right (but not the obligation) to participate in any future priced round on the same terms as the new investor, with his own capital, to maintain up to 10 % ownership.
