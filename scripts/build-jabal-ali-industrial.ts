/**
 * Download all JABAL ALI INDUSTRIAL DEVELOPMENT plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-jabal-ali-industrial.ts
 */
...
const PROJECT_NAME = 'JABAL ALI INDUSTRIAL DEVELOPMENT';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'jabal_ali_industrial.geojson');
