/**
 * Download all TECOM PLOTS - SAIH AL SALAM plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-tecom-saih.ts
 */
...
const PROJECT_NAME = 'TECOM PLOTS - SAIH AL SALAM';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'tecom_saih.geojson');
