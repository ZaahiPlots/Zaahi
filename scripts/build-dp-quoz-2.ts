/**
 * Download all DP PLOTS AT AL QOUZ IND. SECOND plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-dp-quoz-2.ts
 */
...
const PROJECT_NAME = 'DP PLOTS AT AL QOUZ IND. SECOND';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'dp_quoz_2.geojson');
