/**
 * Download all SITE A plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-site-a.ts
 */
...
const PROJECT_NAME = 'SITE A';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'site_a.geojson');
