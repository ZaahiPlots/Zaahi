/**
 * Download all SHAMAL PLOTS WITHIN HADAEQ SHEIKH MOHAMMED BIN RASHID plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-shamal-hadaeq.ts
 */
...
const PROJECT_NAME = 'SHAMAL PLOTS WITHIN HADAEQ SHEIKH MOHAMMED BIN RASHID';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'shamal_hadaeq.geojson');
