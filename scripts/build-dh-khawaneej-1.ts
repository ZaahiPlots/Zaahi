/**
 * Download all DUBAI HOLDING PLOTS AT AL KHAWANEEJ FIRST plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-dh-khawaneej-1.ts
 */
...
const PROJECT_NAME = 'DUBAI HOLDING PLOTS AT AL KHAWANEEJ FIRST';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'dh_khawaneej_1.geojson');
