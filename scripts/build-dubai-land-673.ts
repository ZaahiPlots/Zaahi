/**
 * Download all DUBAI LAND (673) plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-dubai-land-673.ts
 */
...
const PROJECT_NAME = 'DUBAI LAND (673)';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'dubai_land_673.geojson');
