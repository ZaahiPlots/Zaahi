/**
 * Download all DUBAI CREEK HARBOUR plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-dubai-creek-harbour.ts
 */
...
const PROJECT_NAME = 'DUBAI CREEK HARBOUR';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'dubai_creek_harbour.geojson');
