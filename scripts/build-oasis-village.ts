/**
 * Download all OASIS VILLAGE plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-oasis-village.ts
 */
...
const PROJECT_NAME = 'OASIS VILLAGE';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'oasis_village.geojson');
