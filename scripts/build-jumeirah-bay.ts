/**
 * Download all JUMEIRAH BAY plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-jumeirah-bay.ts
 */
...
const PROJECT_NAME = 'JUMEIRAH BAY';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'jumeirah_bay.geojson');
