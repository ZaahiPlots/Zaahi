/**
 * Download all DUBAI LAND (B1-03) plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-dubai-land-b1-03.ts
 */
...
const PROJECT_NAME = 'DUBAI LAND (B1-03)';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'dubai_land_b1_03.geojson');
