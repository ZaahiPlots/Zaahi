/**
 * Download all MERAAS PLOTS AT WADI ALAMARDI plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-meraas-alamardi.ts
 */
...
const PROJECT_NAME = 'MERAAS PLOTS AT WADI ALAMARDI';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'meraas_alamardi.geojson');
