/**
 * Download all ARABIAN RANCHES II plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-arabian-ranches-2.ts
 */
...
const PROJECT_NAME = 'ARABIAN RANCHES II';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'arabian_ranches_2.geojson');
