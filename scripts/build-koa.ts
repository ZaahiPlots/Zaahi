/**
 * Download all KOA REAL ESTATE DEVELOPMENT plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-koa.ts
 */
...
const PROJECT_NAME = 'KOA REAL ESTATE DEVELOPMENT';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'koa.geojson');
