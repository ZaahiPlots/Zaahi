/**
 * Download all TIJARA TOWN plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-tijara-town.ts
 */
...
const PROJECT_NAME = 'TIJARA TOWN';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'tijara_town.geojson');
