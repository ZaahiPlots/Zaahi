/**
 * Download all DIFC ZABEEL plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-difc-zabeel.ts
 */
...
const PROJECT_NAME = 'DIFC ZABEEL';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'difc_zabeel.geojson');
