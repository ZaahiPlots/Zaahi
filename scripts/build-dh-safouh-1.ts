/**
 * Download all DUBAI HOLDING PLOTS AT AL SAFOUH FIRST plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-dh-safouh-1.ts
 */
...
const PROJECT_NAME = 'DUBAI HOLDING PLOTS AT AL SAFOUH FIRST';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'dh_safouh_1.geojson');
