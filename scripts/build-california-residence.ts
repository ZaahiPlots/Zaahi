/**
 * Download all CALIFORNIA RESIDENCE plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-california-residence.ts
 */
...
const PROJECT_NAME = 'CALIFORNIA RESIDENCE';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'california_residence.geojson');
