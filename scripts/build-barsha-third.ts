/**
 * Download all AL BARSHA THIRD DEVELOPMENT plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-barsha-third.ts
 */
...
const PROJECT_NAME = 'AL BARSHA THIRD DEVELOPMENT';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'barsha_third.geojson');
