/**
 * Download all DUBAI HEALTHCARE CITY PHASE 1 plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-dhcc-phase1.ts
 */
...
const PROJECT_NAME = 'DUBAI HEALTHCARE CITY PHASE 1';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'dhcc_phase1.geojson');
