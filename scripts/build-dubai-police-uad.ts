/**
 * Download all DUBAI POLICE PLOTS WITHIN UMM AL DAMAN plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-dubai-police-uad.ts
 */
...
const PROJECT_NAME = 'DUBAI POLICE PLOTS WITHIN UMM AL DAMAN';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'dubai_police_uad.geojson');
