/**
 * Download all NAD AL SHEBA GARDENS plot polygons from DDA layer 2 (BASIC_LAND_BASE)
 * and save as ~/zaahi/data/layers/dda/nad_al_sheba_gardens.geojson.
 *
 * Run: npx tsx scripts/build-nad-al-sheba-gardens.ts
 */
...
const PROJECT_NAME = 'NAD AL SHEBA GARDENS';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'nad_al_sheba_gardens.geojson');
