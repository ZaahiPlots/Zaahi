/**
 * Download all JABAL ALI STAFF ACCOMMODATION plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-jai-staff.ts
 */
...
const PROJECT_NAME = 'JABAL ALI STAFF ACCOMMODATION';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'jai_staff.geojson');
