/**
 * Download all FALCON CITY OF WONDERS plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-falcon-city.ts
 */
...
const PROJECT_NAME = 'FALCON CITY OF WONDERS';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'falcon_city.geojson');
