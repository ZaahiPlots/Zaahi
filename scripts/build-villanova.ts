/**
 * Download all VILLANOVA plot polygons from DDA layer 2 (BASIC_LAND_BASE)
 * and save as ~/zaahi/data/layers/dda/villanova.geojson.
 *
 * Run: npx tsx scripts/build-villanova.ts
 */
...
const PROJECT_NAME = 'VILLANOVA';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'villanova.geojson');
