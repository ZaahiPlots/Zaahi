/**
 * Download all JUMEIRAH GARDEN CITY plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-jumeirah-garden-city.ts
 */
...
const PROJECT_NAME = 'JUMEIRAH GARDEN CITY';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'jumeirah_garden_city.geojson');
