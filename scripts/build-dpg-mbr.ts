/**
 * Download all DPG LANDS WITHIN MOHAMMED BIN RASHED CITY plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-dpg-mbr.ts
 */
...
const PROJECT_NAME = 'DPG LANDS WITHIN MOHAMMED BIN RASHED CITY';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'dpg_mbr.geojson');
