/**
 * Download all MERAAS PLOTS AT NADD AL SHIBA FOURTH plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-meraas-nas-4.ts
 */
...
const PROJECT_NAME = 'MERAAS PLOTS AT NADD AL SHIBA FOURTH';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'meraas_nas_4.geojson');
