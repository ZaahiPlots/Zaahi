/**
 * Download all PEARL JUMEIRA plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-pearl-jumeira.ts
 */
...
const PROJECT_NAME = 'PEARL JUMEIRA';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'pearl_jumeira.geojson');
