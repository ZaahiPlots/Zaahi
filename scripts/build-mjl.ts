/**
 * Download all MADINAT JUMEIRAH LIVING plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-mjl.ts
 */
...
const PROJECT_NAME = 'MADINAT JUMEIRAH LIVING';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'mjl.geojson');
