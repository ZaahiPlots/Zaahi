/**
 * Download all TAORMINA VILLAGE 2 plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-taormina-2.ts
 */
...
const PROJECT_NAME = 'TAORMINA VILLAGE 2';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'taormina_2.geojson');
