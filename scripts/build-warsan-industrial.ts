/**
 * Download all AL WARSAN INDUSTRIAL plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-warsan-industrial.ts
 */
...
const PROJECT_NAME = 'AL WARSAN INDUSTRIAL';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'warsan_industrial.geojson');
