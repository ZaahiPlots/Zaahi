/**
 * Download all BURJ AL ARAB plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-burj-al-arab.ts
 */
...
const PROJECT_NAME = 'BURJ AL ARAB';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'burj_al_arab.geojson');
