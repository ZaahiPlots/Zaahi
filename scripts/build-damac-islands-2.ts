/**
 * Download all DAMAC ISLANDS 2 plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-damac-islands-2.ts
 */
...
const PROJECT_NAME = 'DAMAC ISLANDS 2';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'damac_islands_2.geojson');
