/**
 * Download all JABEL ALI HILLS plot polygons from DDA layer 2 (BASIC_LAND_BASE)
 * and save as ~/zaahi/data/layers/dda/jabel_ali_hills.geojson.
 *
 * Run: npx tsx scripts/build-jabel-ali-hills.ts
 */
...
const PROJECT_NAME = 'JABEL ALI HILLS';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'jabel_ali_hills.geojson');
