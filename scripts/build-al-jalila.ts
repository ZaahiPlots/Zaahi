/**
 * Download all AL JALILA CHILDREN'S SPECIALTY HOSPITAL plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-al-jalila.ts
 */
...
const PROJECT_NAME_SQL = "AL JALILA CHILDREN''S SPECIALTY HOSPITAL";
const PROJECT_NAME = "AL JALILA CHILDREN'S SPECIALTY HOSPITAL";
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'al_jalila.geojson');
