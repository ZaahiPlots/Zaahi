/**
 * Download all DUBAI LAND RESIDENCE COMPLEX plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-dlrc.ts
 */
...
const PROJECT_NAME = 'DUBAI LAND RESIDENCE COMPLEX';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'dlrc.geojson');
