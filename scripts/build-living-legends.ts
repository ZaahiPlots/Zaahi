/**
 * Download all LIVING LEGENDS plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-living-legends.ts
 */
...
const PROJECT_NAME = 'LIVING LEGENDS';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'living_legends.geojson');
