/**
 * Download all MERAAS PLOTS AT MARSA DUBAI plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-meraas-marsa-dubai.ts
 */
...
const PROJECT_NAME = 'MERAAS PLOTS AT MARSA DUBAI';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'meraas_marsa_dubai.geojson');
