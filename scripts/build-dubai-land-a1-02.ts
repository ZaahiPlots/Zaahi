/**
 * Download all DUBAI LAND (A1-02) plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-dubai-land-a1-02.ts
 */
...
const PROJECT_NAME = 'DUBAI LAND (A1-02)';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'dubai_land_a1_02.geojson');
