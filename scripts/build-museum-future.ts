/**
 * Download all MUSEUM OF THE FUTURE plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-museum-future.ts
 */
...
const PROJECT_NAME = 'MUSEUM OF THE FUTURE';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'museum_future.geojson');
