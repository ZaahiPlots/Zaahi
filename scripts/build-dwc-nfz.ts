/**
 * Download all DUBAI WHOLESALE CITY (NON FREE ZONE) plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-dwc-nfz.ts
 */
...
const PROJECT_NAME = 'DUBAI WHOLESALE CITY (NON FREE ZONE)';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'dwc_nfz.geojson');
