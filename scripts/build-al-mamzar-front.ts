/**
 * Download all AL MAMZAR FRONT plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-al-mamzar-front.ts
 */
...
const PROJECT_NAME = 'AL MAMZAR FRONT';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'al_mamzar_front.geojson');
