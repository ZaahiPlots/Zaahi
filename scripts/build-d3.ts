/**
 * Download all DUBAI DESIGN DISTRICT plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-d3.ts
 */
...
const PROJECT_NAME = 'DUBAI DESIGN DISTRICT';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'd3.geojson');
