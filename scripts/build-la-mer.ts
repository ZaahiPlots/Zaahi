/**
 * Download all LA MER plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-la-mer.ts
 */
...
const PROJECT_NAME = 'LA MER';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'la_mer.geojson');
