/**
 * Download all ARABIAN RANCHES III plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-arabian-ranches-3.ts
 */
...
const PROJECT_NAME = 'ARABIAN RANCHES III';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'arabian_ranches_3.geojson');
