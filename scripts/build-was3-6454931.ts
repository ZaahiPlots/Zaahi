/**
 * Download all 6454931 AT WADI AL SAFA 3 plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-was3-6454931.ts
 */
...
const PROJECT_NAME = '6454931 AT WADI AL SAFA 3';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'was3_6454931.geojson');
