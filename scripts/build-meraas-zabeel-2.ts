/**
 * Download all MERAAS PLOTS AT ZAA'BEEL SECOND plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-meraas-zabeel-2.ts
 */
...
const PROJECT_NAME_SQL = "MERAAS PLOTS AT ZAA''BEEL SECOND";
const PROJECT_NAME = "MERAAS PLOTS AT ZAA'BEEL SECOND";
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'meraas_zabeel_2.geojson');
