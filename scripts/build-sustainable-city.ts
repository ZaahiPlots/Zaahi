/**
 * Download all SUSTAINABLE CITY plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-sustainable-city.ts
 */
...
const PROJECT_NAME = 'SUSTAINABLE CITY';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'sustainable_city.geojson');
