/**
 * Download all MERAAS PLOTS AT RAS AL KHOR IND. THIRD plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-meraas-rakhor-3.ts
 */
...
const PROJECT_NAME = 'MERAAS PLOTS AT RAS AL KHOR IND. THIRD';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'meraas_rakhor_3.geojson');
