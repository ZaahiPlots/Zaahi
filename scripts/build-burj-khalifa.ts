/**
 * Download all BURJ KHALIFA DISTRICT plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-burj-khalifa.ts
 */
...
const PROJECT_NAME = 'BURJ KHALIFA DISTRICT';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'burj_khalifa.geojson');
