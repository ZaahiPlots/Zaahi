/**
 * Download all EMIRATES TOWERS DISTRICT plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-emirates-towers.ts
 */
...
const PROJECT_NAME = 'EMIRATES TOWERS DISTRICT';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'emirates_towers.geojson');
