/**
 * Download all MARSA AL ARAB plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-marsa-al-arab.ts
 */
...
const PROJECT_NAME = 'MARSA AL ARAB';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'marsa_al_arab.geojson');
