/**
 * Download all SHAMAL PLOTS AT AL MAMZAR plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-shamal-mamzar.ts
 */
...
const PROJECT_NAME = 'SHAMAL PLOTS AT AL MAMZAR';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'shamal_mamzar.geojson');
