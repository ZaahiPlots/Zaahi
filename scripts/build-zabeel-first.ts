/**
 * Download all ZAA'BEEL FIRST PLOT polygons from DDA layer 2
 * Run: npx tsx scripts/build-zabeel-first.ts
 */
...
const PROJECT_NAME_SQL = "ZAA''BEEL FIRST PLOT";
const PROJECT_NAME = "ZAA'BEEL FIRST PLOT";
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'zabeel_first.geojson');
