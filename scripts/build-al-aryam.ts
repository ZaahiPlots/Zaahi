/**
 * Download all AL ARYAM plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-al-aryam.ts
 */
...
const PROJECT_NAME = 'AL ARYAM';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'al_aryam.geojson');
