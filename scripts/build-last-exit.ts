/**
 * Download all LAST EXIT plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-last-exit.ts
 */
...
const PROJECT_NAME = 'LAST EXIT';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'last_exit.geojson');
