/**
 * Download all MUDON plot polygons from DDA layer 2 (BASIC_LAND_BASE)
 * and save as ~/zaahi/data/layers/dda/mudon.geojson.
 *
 * Run: npx tsx scripts/build-mudon.ts
 */
...
const PROJECT_NAME = 'MUDON';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'mudon.geojson');
