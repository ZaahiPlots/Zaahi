/**
 * Download all THE ACRES plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-the-acres.ts
 */
...
const PROJECT_NAME = 'THE ACRES';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'the_acres.geojson');
