/**
 * Download all REPORTAGE VILLAGE 1&2 plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-reportage-village.ts
 */
...
const PROJECT_NAME = 'REPORTAGE VILLAGE 1&2';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'reportage_village.geojson');
