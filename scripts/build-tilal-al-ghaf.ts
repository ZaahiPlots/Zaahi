/**
 * Download all TILAL AL GHAF plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-tilal-al-ghaf.ts
 */
...
const PROJECT_NAME = 'TILAL AL GHAF';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'tilal_al_ghaf.geojson');
