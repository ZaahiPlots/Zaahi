/**
 * Download all DUBAI INTERNATIONAL ACADEMIC CITY plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-diac.ts
 */
...
const PROJECT_NAME = 'DUBAI INTERNATIONAL ACADEMIC CITY';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'diac.geojson');
