/**
 * Download all THE ECHO PLEX CITY plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-echo-plex.ts
 */
...
const PROJECT_NAME = 'THE ECHO PLEX CITY';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'echo_plex.geojson');
