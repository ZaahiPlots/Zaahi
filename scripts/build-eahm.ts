/**
 * Download all EMIRATES ACADEMY OF HOSPITALITY MANAGEMENT (EAHM) plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-eahm.ts
 */
...
const PROJECT_NAME = 'EMIRATES ACADEMY OF HOSPITALITY MANAGEMENT (EAHM)';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'eahm.geojson');
