/**
 * Download all AL KHAIL HEIGHTS plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-khail-heights.ts
 */
...
const PROJECT_NAME = 'AL KHAIL HEIGHTS';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'khail_heights.geojson');
