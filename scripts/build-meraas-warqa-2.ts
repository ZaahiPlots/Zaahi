/**
 * Download all MERAAS PLOTS AT AL WARQA'A SECOND plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-meraas-warqa-2.ts
 */
...
const PROJECT_NAME_SQL = "MERAAS PLOTS AT AL WARQA''A SECOND";
const PROJECT_NAME = "MERAAS PLOTS AT AL WARQA'A SECOND";
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'meraas_warqa_2.geojson');
