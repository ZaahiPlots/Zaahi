/**
 * Download all SCHOOLS - FREE ZONE plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-schools-fz.ts
 */
...
const PROJECT_NAME = 'SCHOOLS - FREE ZONE';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'schools_fz.geojson');
