/**
 * Download all ARABIAN RANCHES I plot polygons from DDA layer 2 (BASIC_LAND_BASE)
 * and save as ~/zaahi/data/layers/dda/arabian_ranches_1.geojson.
 *
 * Run: npx tsx scripts/build-arabian-ranches-1.ts
 */
...
const PROJECT_NAME = 'ARABIAN RANCHES I';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'arabian_ranches_1.geojson');
