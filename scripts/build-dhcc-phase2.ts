/**
 * Download all DUBAI HEALTHCARE CITY PHASE 2 plot polygons from DDA layer 2
 * (BASIC_LAND_BASE) and save as ~/zaahi/data/layers/dda/dhcc_phase2.geojson.
 *
 * Run: npx tsx scripts/build-dhcc-phase2.ts
 */
...
const PROJECT_NAME = 'DUBAI HEALTHCARE CITY PHASE 2';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'dhcc_phase2.geojson');
