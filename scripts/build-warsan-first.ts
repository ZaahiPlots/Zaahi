/**
 * Download all WARSAN FIRST DEVELOPMENT plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-warsan-first.ts
 */
...
const PROJECT_NAME = 'WARSAN FIRST DEVELOPMENT';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'warsan_first.geojson');
