/**
 * Download all MARSA ALSEEF plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-marsa-alseef.ts
 */
...
const PROJECT_NAME = 'MARSA ALSEEF';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'marsa_alseef.geojson');
