/**
 * Download all DAMAC LAGOONS plot polygons from DDA layer 2 (BASIC_LAND_BASE)
 * and save as ~/zaahi/data/layers/dda/damac_lagoons.geojson.
 *
 * Run: npx tsx scripts/build-damac-lagoons.ts
 */
...
const PROJECT_NAME = 'DAMAC LAGOONS';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'damac_lagoons.geojson');
