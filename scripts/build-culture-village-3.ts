/**
 * Download all CULTURE VILLAGE PHASE 3 plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-culture-village-3.ts
 */
...
const PROJECT_NAME = 'CULTURE VILLAGE PHASE 3';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'culture_village_3.geojson');
