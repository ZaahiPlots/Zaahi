/**
 * Download all AL KHAWANEEJ LABOUR CITY plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-khawaneej-labour.ts
 */
...
const PROJECT_NAME = 'AL KHAWANEEJ LABOUR CITY';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'khawaneej_labour.geojson');
