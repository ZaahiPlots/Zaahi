/**
 * Download all SAMA AL JADAF plot polygons from DDA layer 2 (BASIC_LAND_BASE)
 * and save as ~/zaahi/data/layers/dda/sama_al_jadaf.geojson.
 *
 * Run: npx tsx scripts/build-sama-al-jadaf.ts
 */
...
const PROJECT_NAME = 'SAMA AL JADAF';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'sama_al_jadaf.geojson');
