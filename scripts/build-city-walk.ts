/**
 * Download all CITY WALK plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-city-walk.ts
 */
...
const PROJECT_NAME = 'CITY WALK';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'city_walk.geojson');
