/**
 * Download all BARSHA HEIGHTS plot polygons from DDA layer 2
 * (BASIC_LAND_BASE) and save as ~/zaahi/data/layers/dda/barsha_heights.geojson.
 *
 * Run: npx tsx scripts/build-barsha-heights.ts
 */
...
const PROJECT_NAME = 'BARSHA HEIGHTS';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'barsha_heights.geojson');
