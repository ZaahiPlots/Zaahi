/**
 * Download all MERAAS PLOTS AT SAIH SHUAIB 1 plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-meraas-saih-1.ts
 */
...
const PROJECT_NAME = 'MERAAS PLOTS AT SAIH SHUAIB 1';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'meraas_saih_1.geojson');
