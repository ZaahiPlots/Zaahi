/**
 * Download all MERAAS PLOT 3460266 polygons from DDA layer 2
 * Run: npx tsx scripts/build-meraas-3460266.ts
 */
...
const PROJECT_NAME = 'MERAAS PLOT 3460266';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'meraas_3460266.geojson');
