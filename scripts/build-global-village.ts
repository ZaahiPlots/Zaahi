/**
 * Download all GLOBAL VILLAGE plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-global-village.ts
 */
...
const PROJECT_NAME = 'GLOBAL VILLAGE';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'global_village.geojson');
