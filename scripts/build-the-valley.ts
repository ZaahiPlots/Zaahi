/**
 * Download all THE VALLEY plot polygons from DDA layer 2 (BASIC_LAND_BASE)
 * and save as ~/zaahi/data/layers/dda/the_valley.geojson.
 *
 * Run: npx tsx scripts/build-the-valley.ts
 */
...
const PROJECT_NAME = 'THE VALLEY';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'the_valley.geojson');
