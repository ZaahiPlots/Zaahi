/**
 * Download all WILD WADI WATER PARK plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-wild-wadi.ts
 */
...
const PROJECT_NAME = 'WILD WADI WATER PARK';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'wild_wadi.geojson');
