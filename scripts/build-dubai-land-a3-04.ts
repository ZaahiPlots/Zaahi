/**
 * Download all DUBAI LAND (A3-04) plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-dubai-land-a3-04.ts
 */
...
const PROJECT_NAME = 'DUBAI LAND (A3-04)';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'dubai_land_a3_04.geojson');
