/**
 * Download all THE VILLA plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-the-villa.ts
 */
...
const PROJECT_NAME = 'THE VILLA';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'the_villa.geojson');
