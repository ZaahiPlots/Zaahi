/**
 * Download all BUSINESS BAY PHASE 1 & 2 plot polygons from DDA layer 2
 * (BASIC_LAND_BASE) and save as ~/zaahi/data/layers/dda/business_bay.geojson.
 *
 * Run: npx tsx scripts/build-business-bay.ts
 */
...
const PROJECT_NAME = 'BUSINESS BAY PHASE 1 & 2';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'business_bay.geojson');
