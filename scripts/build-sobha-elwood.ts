/**
 * Download all SOBHA ELWOOD plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-sobha-elwood.ts
 */
...
const PROJECT_NAME = 'SOBHA ELWOOD';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'sobha_elwood.geojson');
