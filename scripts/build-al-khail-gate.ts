/**
 * Download all AL KHAIL GATE plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-al-khail-gate.ts
 */
...
const PROJECT_NAME = 'AL KHAIL GATE';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'al_khail_gate.geojson');
