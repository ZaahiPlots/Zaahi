/**
 * Download all 6461281 AT DUBAI LAND plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-dl-6461281.ts
 */
...
const PROJECT_NAME = '6461281 AT DUBAI LAND';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'dl_6461281.geojson');
