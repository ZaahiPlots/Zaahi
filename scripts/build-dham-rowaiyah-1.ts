/**
 * Download all DHAM PLOTS AT AL ROWAIYAH FIRST plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-dham-rowaiyah-1.ts
 */
...
const PROJECT_NAME = 'DHAM PLOTS AT AL ROWAIYAH FIRST';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'dham_rowaiyah_1.geojson');
