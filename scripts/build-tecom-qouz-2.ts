/**
 * Download all TECOM PLOTS AT AL QOUZ IND.SECOND plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-tecom-qouz-2.ts
 */
...
const PROJECT_NAME = 'TECOM PLOTS AT AL QOUZ IND.SECOND';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'tecom_qouz_2.geojson');
