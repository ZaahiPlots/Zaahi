/**
 * Download all LABOUR ACCOMMODATION AT AL QUOZ plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-labour-quoz.ts
 */
...
const PROJECT_NAME = 'LABOUR ACCOMMODATION AT AL QUOZ';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'labour_quoz.geojson');
