/**
 * Download all JUMEIRAH GROUP PLOTS AT JUMEIRA SECOND plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-jg-jumeira-2.ts
 */
...
const PROJECT_NAME = 'JUMEIRAH GROUP PLOTS AT JUMEIRA SECOND';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'jg_jumeira_2.geojson');
