/**
 * Download all ARABIAN RANCHES POLO CLUB plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-ar-polo.ts
 */
...
const PROJECT_NAME = 'ARABIAN RANCHES POLO CLUB';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'ar_polo.geojson');
