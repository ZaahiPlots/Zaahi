/**
 * Download all CITY OF ARABIA plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-city-of-arabia.ts
 */
...
const PROJECT_NAME = 'CITY OF ARABIA';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'city_of_arabia.geojson');
