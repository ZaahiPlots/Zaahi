/**
 * Download all DUBAI SCIENCE PARK plot polygons from DDA layer 2 (BASIC_LAND_BASE)
 * and save as ~/zaahi/data/layers/dda/dubai_science_park.geojson.
 *
 * Run: npx tsx scripts/build-dubai-science-park.ts
 */
...
const PROJECT_NAME = 'DUBAI SCIENCE PARK';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'dubai_science_park.geojson');
