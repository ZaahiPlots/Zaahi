/**
 * Download all AL HABTOOR POLO plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-al-habtoor-polo.ts
 */
...
const PROJECT_NAME = 'AL HABTOOR POLO';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'al_habtoor_polo.geojson');
