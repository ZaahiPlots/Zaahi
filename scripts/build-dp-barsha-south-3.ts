/**
 * Download all DP PLOTS AT AL BARSHA SOUTH THIRD plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-dp-barsha-south-3.ts
 */
...
const PROJECT_NAME = 'DP PLOTS AT AL BARSHA SOUTH THIRD';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'dp_barsha_south_3.geojson');
