/**
 * Download all MERAAS PLOTS WITHIN UMM AL SHEIF plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-meraas-umm-al-sheif.ts
 */
...
const PROJECT_NAME = 'MERAAS PLOTS WITHIN UMM AL SHEIF';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'meraas_umm_al_sheif.geojson');
