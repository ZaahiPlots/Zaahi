/**
 * Download all JUMEIRA BEACH HOTEL plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-jbh.ts
 */
...
const PROJECT_NAME = 'JUMEIRA BEACH HOTEL';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'jbh.geojson');
