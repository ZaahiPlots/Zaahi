/**
 * Download all SHAMAL PLOTS AT JABAL ALI INDUSTRIAL FIRST plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-shamal-jai-1.ts
 */
...
const PROJECT_NAME = 'SHAMAL PLOTS AT JABAL ALI INDUSTRIAL FIRST';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'shamal_jai_1.geojson');
