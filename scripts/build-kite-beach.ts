/**
 * Download all KITE BEACH plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-kite-beach.ts
 */
...
const PROJECT_NAME = 'KITE BEACH';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'kite_beach.geojson');
