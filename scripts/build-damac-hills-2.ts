/**
 * Download all DAMAC HILLS 2 plot polygons from DDA layer 2 (BASIC_LAND_BASE)
 * and save as ~/zaahi/data/layers/dda/damac_hills_2.geojson.
 *
 * Run: npx tsx scripts/build-damac-hills-2.ts
 */
...
const PROJECT_NAME = 'DAMAC HILLS 2';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'damac_hills_2.geojson');
