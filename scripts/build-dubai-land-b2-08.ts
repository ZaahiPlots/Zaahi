/**
 * Download all DUBAI LAND (B2-08) plot polygons from DDA layer 2
 * Run: npx tsx scripts/build-dubai-land-b2-08.ts
 */
...
const PROJECT_NAME = 'DUBAI LAND (B2-08)';
const PAGE = 2000;
const PAUSE_MS = 500;

const DDA_DIR = join(homedir(), 'zaahi', 'data', 'layers', 'dda');
const OUT_PATH = join(DDA_DIR, 'dubai_land_b2_08.geojson');
